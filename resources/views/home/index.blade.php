...
@section('content')
    ...
    <div class="relative">
        <div class="w-full h-96 rounded-2xl overflow-hidden relative shadow-2xl shadow-cyan-100/30">
            <!-- Rasm -->
            <img 
                src="{{ asset('images/azatbek.jpg') }}" 
            ...
            <div class="absolute bottom-0 left-0 right-0 p-8">
                <div class="flex items-end justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-white">Azatbek Ermalaev</h2>
                        <p class="text-cyan-300 text-sm font-medium">Full Stack Developer</p>
                        <div class="flex gap-2 mt-2">
                            <span class="px-2.5 py-0.5 bg-white/20 backdrop-blur-sm rounded-lg text-xs font-medium text-white border border-white/20">PHP</span>
                            <span class="px-2.5 py-0.5 bg-white/20 backdrop-blur-sm rounded-lg text-xs font-medium text-white border border-white/20">Laravel</span>
                            <span class="px-2.5 py-0.5 bg-white/20 backdrop-blur-sm rounded-lg text-xs font-medium text-white border border-white/20">React</span>
                        </div>
                    </div>
                    <div class="flex gap-2">
                        <a href="https://t.me/A_z_a_t_b_e_k" target="_blank" class="w-9 h-9 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-white/40 transition-all border border-white/20">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M22 2 11 13"/><path d="M22 2 15 22l-4-9-9-4Z"/>
                            </svg>
                        </a>
                        <a href="https://github.com/azatbek-07" target="_blank" class="w-9 h-9 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center hover:bg-white/40 transition-all border border-white/20">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/>
                            </svg>
                        </a>
        ...
        <div class="absolute -top-4 -right-4 bg-white/90 backdrop-blur-sm border border-slate-200/60 rounded-xl px-4 py-3 shadow-xl shadow-slate-200/50">
            <p class="text-xs text-slate-400 font-medium">Talaba</p>
            <p class="text-lg font-extrabold text-slate-800">2-kurs</p>
        </div>

        <div class="absolute -bottom-4 -left-4 bg-white/90 backdrop-blur-sm border border-slate-200/60 rounded-xl px-4 py-3 shadow-xl shadow-slate-200/50">
